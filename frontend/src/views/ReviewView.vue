        ...
        <form class="p-6 space-y-6">
            <div class="flex gap-10">
                ...
                <fieldset class="fieldset">
                    ...
                    <select class="select select-error">
                        ...
                        <option>คณะบริหารธุรกิจ เศรษฐศาสตร์และการสื่อสาร</option>
                        <option>คณะวิทยาศาสตร์</option>
                        <option>คณะวิศวกรรมศาสตร์</option>
                        <option>คณะวิทยาศาสตร์การแพทย์</option>
            ...
            <div class="bg-[#FFAE00]/35 p-6 rounded-3xl">
                ...
                <fieldset class="mb-4 pl-5">
                    ...
                    <div class="pl-5">
                        <label class="block">
                            <input type="radio" name="teamWork" class="radio radio-sm radio-error bg-white/50" />
                            ไม่มี
                        </label>
                        <label class="block">
                            <input type="radio" name="teamWork" class="radio radio-sm radio-error bg-white/50" />
            ...
            <div class="bg-[#FBCAA8]/95 p-6 rounded-3xl">
                <fieldset class="pl-5">
                    ...
                    <div class="pl-5">
                        <label class="block">
                            <input type="radio" name="soloWork" class="radio radio-sm radio-error bg-white/50" />
                            ไม่มี
                        </label>
                        <label class="block">
                            <input type="radio" name="soloWork" class="radio radio-sm radio-error bg-white/50" />
